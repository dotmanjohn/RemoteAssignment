...
********************************************************************
SELECT "TotalChildren", avg("YearlyIncome") avg_income , max("YearlyIncome") max_income, 
min("YearlyIncome") min_income, count(1) cust_count
FROM "DimCustomer"
...
•	Top 10 ordered products by SalesAmount 
...
Script:
********************************************************************
select Month_, SalesAmount, OrderDate 
from
(select to_char("OrderDate",'MM-YYYY') Month_,
...
<img width="228" alt="Question 1" src="https://user-images.githubusercontent.com/63157768/231434899-96883aed-5292-4196-8ead-9fb5a02ddf67.png">
...
select "ProductKey", 
 ...
 to_char("OrderDate",'MM-YYYY') Month_
from "FactResellerSales"
where date("OrderDate") between '2012-01-01' and '2012-12-31'
group by 1,3

<img width="273" alt="Question 2" src="https://user-images.githubusercontent.com/63157768/231434953-63b3cb56-24b4-49f9-8416-817818ae6a28.png">
...
sales_rank as (
	select *, row_number() over (partition by Month_ order by amount) rn
	from base
	)

select Month_, "SalesTerritoryCountry", "ProductName", amount SalesAmount
from sales_rank
where rn = 1

<img width="397" alt="Question 4" src="https://user-images.githubusercontent.com/63157768/231435078-71f40de5-e1e7-41cf-85d0-c0c3b5210c43.png">
...
![image](https://user-images.githubusercontent.com/63157768/231419783-7b6b1ecb-e9b3-4028-860b-e69445fdf54f.png)
